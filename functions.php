	...
	$comments_arg = array(
		...
		'fields' => apply_filters( 'comment_form_default_fields', array(
			...
			'author' => '<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label comment-form-author">'.
		                ...
		                '<label class="mdl-textfield__label" for="author">' . __( 'Name', 'default' ) . ($req ? '<span class="required">*</span>' : '') . '</label></div>',
			'email' => '<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label comment-form-email">'.
			            ...
			            '<label class="mdl-textfield__label" for="email">' . __( 'Email', 'default' ) . ($req ? '<span class="required">*</span>' : '' ) . '</label></div>',
			'url' => '<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label comment-form-url">'.
		             ...
		             '<label class="mdl-textfield__label" for="url">' . __( 'Website', 'default' ) . '</label></div>',
			)
		),
	);
